...
col1,col2,col3,col4 = np.loadtxt('fiber3',usecols=(1,2,3,4),unpack=True)
...
ggg=open('normalizations_fiber3','w')
ggg.write('%s\t%f\t%f\t%f\n' %(nrm1,nrm2,nrm3,nrm4))
ggg.write('%s\t%f\t%f\t%f\n' %(min1,min2,min3,min4))
ggg.close()

f=open('fiber3_norm.dat','w')
...
norm1,norm2,norm3,norm4 = np.loadtxt('fiber3_norm.dat',usecols=(0,1,2,3),unpack=(True))
